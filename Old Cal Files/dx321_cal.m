...
PRESS=struct;
PRESS.POLY=[18.89, 2274.05, -97.48];
PRESS.METHOD='rough';
...
ACC.POLY=[15.2743, -7.5929; 15.0648, -7.4084; 15.2019, -7.6344];
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[637.2608, -188.2077; 625.9485, -215.3974; 669.5272, -226.3921];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
