...
PRESS=struct;
PRESS.POLY=[-303.65       3065.31       -122.53];
PRESS.METHOD='rough';
...
ACC.POLY=[14.9445, -7.3239; 15.1653, -7.4913; 15.0139   -7.4436];      
ACC.UNIT='g';
ACC.TREF = 20 ;
ACC.TC.POLY=[0; 0; 0];
ACC.PC.POLY=[0; 0; 0];
...
MAG.POLY=[661.70 -252.98; 670.24 -200.48; 604.87 -206.26];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
MAG.TC.POLY=[0;0;0];
MAG.TC.SRC='BRIDGE';
