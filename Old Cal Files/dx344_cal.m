...
PRESS=struct;
PRESS.POLY=[175.71       2203.28        -85.88];
PRESS.METHOD='rough';
PRESS.LASTCAL=[2023 6 25];
PRESS.TREF = 20 ;
...
ACC.METHOD='flips';
ACC.LASTCAL=[2023 6 15];

MAG=struct;
MAG.TYPE='magnetoresistive bridge';
MAG.POLY=[709.00       -257.79
          710.08       -249.45
          697.67       -217.36];
