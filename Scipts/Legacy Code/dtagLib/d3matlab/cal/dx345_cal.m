%Dtag3X #345 Cal file template
%Initial Calibration - Summer 2023

DEV = struct ;
DEV.ID='e2231f29';
DEV.NAME='DX345';
DEV.BUILT=[2023 01 15];
DEV.BUILDER='EM';
...
PRESS=struct;
PRESS.POLY=[215.45 2483.58 -88.36];
PRESS.METHOD='rough';
PRESS.LASTCAL=[2022 4 20];
PRESS.TREF = 20 ;
...
ACC.METHOD='flips';
ACC.LASTCAL=[2022 4 20];

MAG=struct;
MAG.TYPE='magnetoresistive bridge';
MAG.POLY=[682.56	-238.59
          665.55	-225.91
          659.98	-213.46];
MAG.UNIT='Tesla';
MAG.TREF = 20 ;
